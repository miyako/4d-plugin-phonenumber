...
class NumberFormat : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.NumberFormat) */ {
 public:
  ...
  inline NumberFormat* New() const PROTOBUF_FINAL { return New(NULL); }

  NumberFormat* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class PhoneNumberDesc : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneNumberDesc) */ {
 public:
  ...
  inline PhoneNumberDesc* New() const PROTOBUF_FINAL { return New(NULL); }

  PhoneNumberDesc* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
class PhoneMetadata : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneMetadata) */ {
 public:
  ...
  inline PhoneMetadata* New() const PROTOBUF_FINAL { return New(NULL); }

  PhoneMetadata* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
class PhoneMetadataCollection : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:i18n.phonenumbers.PhoneMetadataCollection) */ {
 public:
  ...
  inline PhoneMetadataCollection* New() const PROTOBUF_FINAL { return New(NULL); }

  PhoneMetadataCollection* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
inline void PhoneMetadata::clear_sms_services() {
  if (sms_services_ != NULL) sms_services_->::i18n::phonenumbers::PhoneNumberDesc::Clear();
